...
a and d contain cycles. For a, the cycle is 1,2,3,4. For d, the cycle is 1,2,5.

### 3. Draw a diagram for this graph.

*G* = ({1, 2, 3, 4, 5}, {{1, 2}, {2, 3}, {3, 4}, {4, 5}, {1, 5}})

See images/problem3.png:
![](images/problem3.png)
...
*G* = ({1, 2, 3, 4, 5, 6}, {{1,2}, {1,3}, {2,3}, {3,4}, {3,5}, {4,5}})
